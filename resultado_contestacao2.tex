...
\begin{center}
  ...
  {\large Contestação 2 --- Marcio Passos de Albuquerque}\\[0.2em]
  {\small Processo n.º 7001233-69.2024.5.03.5129 \quad NB: 44/448.972.569-3 \quad DER: 22/09/2025}
\end{center}
...
\textit{Evidência: ... SENHOR(A) DOUTOR(A) JUIZ(A) FEDERAL DA 4ª VARA FEDERAL DO JUIZADO ESPECIAL FEDERAL DA SUBSEÇÃO JUDICIÁRIA DE SÃO PAULO -- SP Processo n.º 700123...}
...
\textit{Evidência: ... que lhe move MARCIO PASSOS DE ALBUQUERQUE, vem, respeitosamente...}
...
\textcolor{corVERIFICAR}{\textbf{Redistribuição sugerida --- flag SAÚDE}} (indício(s): laboratório + agente biológico).
